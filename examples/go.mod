module github.com/unmango/pulumi-homelab/examples

go 1.17

require github.com/pulumi/pulumi/pkg/v3 v3.25.1
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/kms v1.15.0 // indirect
