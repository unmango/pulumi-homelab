...
namespace Pulumi.UnMango.Homelab
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.UnMango.Homelab.version.txt");
    ...
    internal sealed class HomelabResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public HomelabResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
